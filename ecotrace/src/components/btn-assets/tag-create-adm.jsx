...
const CreateTagAdm = ({ setCreate, user, who }) => {
          ...
          {revisi && (
            <div className="flex flex-col items-center">
              <input
                type="text"
                name="isiRevisi"
                value={form.isiRevisi}
                onChange={change}
                placeholder="Berikan Revisi"
                className="w-full border border-gray-400 rounded-full h-9 px-4 placeholder-gray-300"
              />
              <h3
                onClick={() => {
                  updateRev();
